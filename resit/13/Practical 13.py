...
for i in range(len(sequence3)):  #random and mouse
...
[X, Y, M] = distance_matrix(seq3, seq4)

score=M[len(seq4)][len(seq3)]
...
[X, Y, M] = distance_matrix(seq5, seq6)

score=M[len(seq6)][len(seq5)]
print('random and mouse')
print("Alignment Score:"+ str(score))
print('percentage is ',m)

if k > l:
    print('random and human are closer')
else:
    print('mouse and human are closer')